...
module.exports = function (context) {
    ...
    function addRunpathSearchBuildProperty(proj, build) {
        ...
        }else if (LD_RUNPATH_SEARCH_PATHS.indexOf("$(inherited)") == -1) {
                var newValue = LD_RUNPATH_SEARCH_PATHS.substr(0, LD_RUNPATH_SEARCH_PATHS.length - 1);
                newValue += ' $(inherited)\"';
                proj.updateBuildProperty("LD_RUNPATH_SEARCH_PATHS", newValue, build);
        }
    ...
    myProj.parseSync();
  	console.log ("xCodeProject Path Payme::"+JSON.stringify(myProj));
    ...
    console.log("Proj FirstTarget Name: "+projectName);
